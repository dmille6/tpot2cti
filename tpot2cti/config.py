...
class RuntimeConfig:
    ...
    Previously some of these were read via ``os.environ`` directly from
    main.py, bypassing the config validation layer. Per the 2026-05-22
    audit #4 they live here now so the dataclass is
