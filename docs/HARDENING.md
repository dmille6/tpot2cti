...
**forward path** right: a packet from `192.0.2.20:*` → `node2:64297` (or
...
|---|---|---|---|---|
| Forward (SYN) | `192.0.2.20` | `192.0.2.10` | `64297` | ACCEPT ✓ |
| Return (SYN-ACK) | `172.23.0.5` (container) | `192.0.2.10` | `64297` | DROP ✗ |

Because the ADMIN-allow rules are scoped `-s 192.0.2.20`, return
...
# 3  78  4688  ACCEPT  ...  192.0.2.20  ctorigdst 76...  ctorigdstport 64297
...
ADMIN_IPS=("192.0.2.20" "192.0.2.11")
